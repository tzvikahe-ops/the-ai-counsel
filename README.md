...
**The AI Counsel** היא מערכת דיון רב-מודלית בשני מצבים. במקום להסתמך על מודל בודד לקבלת תשובות, היא מתזמרת מספר מודלי AI שעובדים יחד - דרך סקירת עמיתים אנונימית או דיון מבוסס פרסונות.
...
זוהי גרסת עברית של [the-ai-counsel](https://github.com/jacob-bd/the-ai-counsel) מאת [Jacob Ben-David](https://github.com/jacob-bd) עם:
...
פתח http://localhost:5173 ועקוב אחר ההוראות. הממשק נטען אוטומטית בעברית. השלם שני צעדים אחרי ההתקנה:

1. **מפתחות API** - היכנס ל-⚙️ הגדרות → "מפתחות API של LLM" והזן את המפתחות שלך (OpenRouter / Anthropic / Google / וכו').
